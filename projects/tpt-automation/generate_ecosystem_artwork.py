#!/usr/bin/env python3
"""
Generate TPT-Ready Ecosystem Coloring Sheet Artwork
Uses OpenAI DALL-E 3 to create black-and-white line art
...
sys.path.append(r'C:\Users\MarieLexisDad\scripts\api-helpers')
...
def generate_ecosystem_artwork():
    ...
    for element_id, element_data in ecosystem_elements.items():
        ...
        print(f"{'-' * 80}")
        print(f"Prompt: {element_data['prompt'][:100]}...")

        try:
            # Generate image with DALL-E 3
            print("Calling OpenAI DALL-E 3 API...")
            response = helper.generate_image(
